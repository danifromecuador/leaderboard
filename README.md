...
**Leaderboard!** is my fivth project at Microverse, in this project I have created a basic app that shows an score with name and points using an API that allows other users upload their own scores.
...
- **This project uses webpack and ES6**
- **This project also uses API**
...
- [Leaderboard API](https://danifromecuador.github.io/leaderboard/dist/)
...
- Step 2: Once you have installed git you can clone this project using the command below:
  ```
  git clone git@github.com:danifromecuador/leaderboard.git
  ```
...
- The app will show extra details of each player
